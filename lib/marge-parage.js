...
function calculerMarge(args) {
    ...
    for (const cat of CATEGORIES) {
        ...
        resultat[cat] = {
            ...
            // Ecart entre le theorique de la categorie et les kilos reellement
            // valorises. Il absorbe DEUX causes: prix d'achat absent, et
            // theorique negatif ecarte ci-dessus - il peut donc etre negatif.
            // A ne pas publier tel quel; lib/parage-periode.js s'en sert
            // uniquement pour retrouver kgCoutes par difference.
