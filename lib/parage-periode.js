...
const { CATEGORIES, SEUIL_KG } = require('./parage');
...
function cumulerMois(parageParJour) {
    ...
    for (const cat of CATEGORIES) {
        const t = total[cat];
        // Le MEME seuil qu'en lib/parage.js et qu'ici plus bas. Compare a zero,
        // ce cumul aurait laisse passer un residu de virgule flottante et rendu
        // un taux sur une somme d'un microgramme.
        t.ratio = t.theorique > SEUIL_KG ? t.vendu / t.theorique : null;
