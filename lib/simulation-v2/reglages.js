...
async function lireReglages() {
    ...
    try {
        ...
        return { ...DEFAUTS, famillePoulet: DEFAUTS.famillePoulet.slice(), avertissements };
    }
...
function valider(corps) {
    ...
    if (corps.famillePoulet !== undefined) {
        ...
        if (liste === null) {
            erreurs.push('famillePoulet doit être une liste de noms, sans virgule dans un nom');
