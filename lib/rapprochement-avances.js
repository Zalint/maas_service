 ...
 *
 * Verifie sur aout 2026 a Mbao, l'accord etait alors exact au franc:
 ...
 *
 * CES TROIS EXEMPLES NE SE REPRODUISENT PLUS, et c'est attendu: ils ont ete
 * releves quand Maas valorisait au prix ENREGISTRE, hors commission (bœuf a
 * 4 500, Yell a 2 000). Depuis, la valorisation suit le prix que MATA facture
 * reellement - commission comprise (cf lib/commission-integree.js) - parce que
 * la vente au partenaire MaaS est encaissee a ce prix-la: une carcasse facturee
 * 4 635 F/kg est encaissee 4 635, et l'avance de MataBanq porte le meme montant.
 * Rejouer ces journees rend donc 721 340 / 514 797 / 359 808, l'ecart valant
 * exactement la commission.
 *
 * L'accord reste donc la regle, sur la nouvelle base des deux cotes. Un ecart
 * sur des journees ANCIENNES, saisies avant ce basculement, ne signale pas une
 * divergence de saisie: les deux bouts n'y parlaient pas encore du meme prix.
 *
